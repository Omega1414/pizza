...
const CartItem = ({pizza}) => {
  const {removeItem, decreaseAmount, increaseAmount} = useContext(CartContext)
  return <div className="select-none">
    <div className="flex gap-x-4 mb-2">
      ...
      <div className="flex-1 flex flex-col gap-y-1">
        ...
        <div className="flex flex-col gap-y-1">
          <div className="capitalize font-medium text-[15px]">{pizza.crust} xəmir </div>
          <div className="capitalize mb-2 font-medium text-[15px]">{pizza.size} ölçü</div>
    ...
    <div className="font-semibold">
      Əlavələr: {pizza.additionalTopping.length === 0 && 'None'}
    </div>
