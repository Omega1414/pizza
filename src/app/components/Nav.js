...
const Nav = () => {
  ...
  return <nav className="absolute w-full py-8">
    <div className="container mx-auto flex flex-col lg:flex-row gap-y-3 justify-between items-center">
      <Link href='#' className="max-w-[160px] lg:max-w-max pb-4 lg:pb-0" >
      ...
      <div className="flex gap-x-8 items-center">
        <div className="flex gap-x-3 items-center">
          ...
          <div className="text-white">
            ...
            <div className="text-3xl font-robotoCondensed font-extrabold leading-none tracking-wide">050 --- -- --</div>
          </div>
        </div>
